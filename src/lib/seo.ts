...
export function pageHead(title: string, description: string, path: string) {
  ...
  return {
    meta: [
      ...
      { property: "og:site_name", content: "VCARDe NFC Business Cards" },
...
export const localBusinessLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      image: ogImage,
      description:
        "NFC business card printer and digital visiting card platform in Mylapore, Chennai. Custom NFC visiting cards from ₹499 and Google review NFC cards from ₹299. Free shipping in India.",
      url: origin,
      telephone: site.phones[0].raw,
      priceRange: "₹299–₹1499",
      address: {
      ...
      parentOrganization: { "@id": `${origin}/#parent` },
    },
    {
      "@type": "Product",
